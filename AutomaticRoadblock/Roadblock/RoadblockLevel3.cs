...
{
    public class RoadblockLevel3 : AbstractRoadblock
    {
        public RoadblockLevel3(Road road, Vehicle vehicle, bool limitSpeed, bool addLights)
        ...
        {
            return new RoadblockSlotLevel3(lane, heading, targetVehicle, shouldAddLights);
        }
