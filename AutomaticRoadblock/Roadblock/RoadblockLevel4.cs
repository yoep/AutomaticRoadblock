...
{
    public class RoadblockLevel4 : AbstractRoadblock
    {
        public RoadblockLevel4(Road road, Vehicle vehicle, bool limitSpeed, bool addLights) 
        ...
        {
            return new RoadblockSlotLevel4(lane, heading, targetVehicle, shouldAddLights);
        }
