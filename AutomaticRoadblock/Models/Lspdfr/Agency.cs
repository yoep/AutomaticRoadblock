...
namespace AutomaticRoadblocks.Models.Lspdfr
{
    public class Agency
    {
        ...
        public Agency(string name, string shortName, string scriptName, [CanBeNull] string inventory, [CanBeNull] string textureDictionary, [CanBeNull] string textureName, Loadout loadout)
        {
            Name = name;
            ShortName = shortName;
        ...
        protected bool Equals(Agency other)
        {
            return Name == other.Name && ShortName == other.ShortName && ScriptName == other.ScriptName && Inventory == other.Inventory &&
                   TextureDictionary == other.TextureDictionary && TextureName == other.TextureName && Equals(Loadout, other.Loadout);
        }
